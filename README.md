...
Now that youve gotten this far its time for the next best part 
...
once this pops up if it works it will ask for a username and password to get in. which at this point thats what you want to see but if somethings wrong like a port youll get an error like this
